            ...
            <Container>
                <Zoom>
                    <h2 className="text-center text-dark mb-5">
                        WELCOME TO YOU AT TAMIM DIAGONOSTIC CENTER (PVT) LTD.
                    </h2>
                </Zoom>
                <Row>
                    <Col md className="pe-3">
                        <Bounce bottom>
                            <h5 className="text-black">If you want to lift yourself up, lift up someone else.</h5>
                    ...
                    <Col md className="pe-3">
                        <Bounce bottom>
                            <h5 className="text-black">You want to join our team?</h5>
                            <p className="text-muted">
                ...
                <Row className="mt-4">
                    <Col md>
                        <Bounce bottom>
                            <h3 className="text-danger">Sign up for our monthly newsletter</h3>
                            <p className="text-muted">
